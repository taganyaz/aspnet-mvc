...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LastName,FirstName,HireDate,OfficeAssignment")] Instructor instructor, string[] selectedCourses)
        {
            if (id != instructor.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if(string.IsNullOrWhiteSpace(instructor.OfficeAssignment?.Location))
                    {
                        ...
                        {
                            _context.Remove(instructorToUpdate.OfficeAssignment);
        ...
        private void PopulateAssignedCourseData(Instructor instructor)
        {
            ...
            var assignedCourses = new HashSet<int>(instructor.CourseAssignments.Select(c => c.CourseId));
            ...
            foreach(var course in allCourses)
            {
                viewModel.Add(new AssignedCourseData
                {
                    ...
                    Title = course.Title,
                    Assigned = assignedCourses.Contains(course.CourseId)
                });
            }
