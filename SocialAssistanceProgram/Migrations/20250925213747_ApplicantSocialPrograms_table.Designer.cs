...
namespace SocialAssistanceProgram.Migrations
{
    ...
    [Migration("20250925213747_ApplicantSocialPrograms_table")]
    partial class ApplicantSocialPrograms_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicantSocialProgram", b =>
                {
                    b.Property<int>("ApplicantsId")
                        .HasColumnType("int");

                    b.Property<int>("SocialProgramsId")
                        .HasColumnType("int");

                    b.HasKey("ApplicantsId", "SocialProgramsId");

                    b.HasIndex("SocialProgramsId");

                    b.ToTable("ApplicantSocialProgram");
                });
            ...
            modelBuilder.Entity("SocialAssistanceProgram.Core.Domain.Models.PhoneContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicantSocialProgram", b =>
                {
                    b.HasOne("SocialAssistanceProgram.Core.Domain.Models.Applicant", null)
                        .WithMany()
                        .HasForeignKey("ApplicantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialAssistanceProgram.Core.Domain.Models.SocialProgram", null)
                        .WithMany()
                        .HasForeignKey("SocialProgramsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
